...
// Reads: 04 (K, FOR).
  ...
  const MT_PARAMS: MtParam[] = [
    ...
    {key:'K.BAY_GRAB', group:'routing', label:'Зона захвата ангара',          target:'K',  name:'BAY_GRAB',     def:K.BAY_GRAB,     min:0,   max:80,  step:1,    note:'Запас вокруг бокса, в который прилипает конец маршрута (px). Зона рисуется на поле.', impact:'Больше — легче завести борт в ангар; 0 — ровно прямоугольник бокса.'},
    // ── столкновения ──────────────────────────────────────────────────────────
