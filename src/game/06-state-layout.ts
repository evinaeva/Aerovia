...
// Reads: 01 (cv, ctx); 04 (LV, curBiome, curBonus, levelName, bonusName); 03 (t, lang); 04b (MT_META_VALUES — for safe-zone params).
  ...
  // Единый масштаб «крупности» техники: из него выводятся ШИРИНА ВПП (rh = борт ×
  // K.RUNWAY_RATIO) и сторона квадратного ангара. ДЛИНА ВПП не зависит от масштаба
  // борта — управляется независимым параметром K.RUNWAY_R (доля ширины экрана).
