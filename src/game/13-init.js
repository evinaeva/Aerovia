...
// Reads: ~all modules — 11 (showStart/showLevels/loadGame/saveGame/applyMenuIcons), 10 (frame), 06 (save/resize/VERSION), 05 (validateGame), 03 (applyI18n/setLang/t), 07 (SND/HAP/Analytics/Leaderboard), 12 (ACH/openMedals), 08 (computeStars…), 04 (config + test-API exports).
  ...
  (function loadHandoffSprites(){
    ...
    HANDOFF_IMG.hudMenu    = loadI('assets/sprites/neon/hud-menu.png');  // «левое меню HUD» (иконки запечены, значения — нет)
  ...
  if(typeof location!=='undefined' && /[?&]test=1(?:&|$)/.test(location.search)){
    window.__GAME = {
      ...
      get hazards(){ return hazards; }, get crews(){ return crews; },
      get planes(){ return planes; }, get runways(){ return runways; }, get bays(){ return bays; },
      spawnPlane, spawnHazard, dispatchCrew, resolveHazard, updateForest, buildBiome, reset,
      validateGame, validateLevels, validateBonus, validateBiomes, validateI18n, validateConfig, validateAch,
