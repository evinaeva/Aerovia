...
// Reads: 03 (I18N, t, lang, DEFAULT_LANG); 06 (state: gameTime, served, runways, save, combo, debug, weather, effects, levelIdx).
  ...
  const K = {
    ...
    PLANE_SKY_SCALE: 2,   // масштаб борта в небе
    ...
    PLANE_SCALE: 1.15,    // общий масштаб борта (крупность техники)
    RUNWAY_RATIO: 1.23,   // ширина ВПП / длина борта (≈ размах + запас)
    RUNWAY_R: 0.81,       // правый (небесный) край ВПП, доля ширины экрана; длина ≈(RUNWAY_R−0.63)×W
    ...
    WEATHER_SNOW_TAXI: 0.1,           // множитель скорости руления под снегом (хуже дождя)
