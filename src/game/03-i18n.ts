...
// Reads: 06 (save); 07 (Analytics).
  ...
  const I18N = (() => {
    const en = {
      ...
      'start.play':'Play', 'start.levels':'Levels', 'start.fullscreen':'Fullscreen',
      ...
      'share.text':'PlaneFlow — neon air traffic control. Land planes with your finger and keep the flow.',
      ...
      'start.season':'Season ends in {n} {unit}',
      ...
      'toast.seasonStart':'Season {n} has begun!',
    ...
    const ru: LangMeta & Record<PhraseKey, Phrase> = {
      ...
      'start.play':'Играть', 'start.levels':'Уровни', 'start.fullscreen':'Во весь экран',
      ...
      'share.text':'PlaneFlow — неоновый авиадиспетчер. Сажай борты пальцем и держи поток.',
      ...
      'start.season':'До конца сезона: {n} {unit}',
      ...
      'toast.seasonStart':'Стартовал Сезон {n}!',
