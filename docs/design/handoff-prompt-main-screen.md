...
10. **Чего НЕ трогать** — `HUD_H` (высота верхнего бара), `index.html`, идентичность
    палитры `--m-*`. (К раскладке игрового поля — апрон/ангары/ВПП — требований больше
    нет; см. neon HANDOFF. Просто не меняй её как побочку задачи про главный экран.)
