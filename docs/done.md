...
- **Survival — бесконечное выживание на картах** (v0.25; заменил Zen-режим v0.8): кнопка
  «Выживание» ведёт на карты, жизни включены, личный рекорд по бортам + счёт в глобальный рейтинг.
